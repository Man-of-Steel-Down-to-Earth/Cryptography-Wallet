<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_auditors.aspx.cs" Inherits="Admin_view_auditors" %>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page general">
				<h3 class="title1">VIEW AUDITOR DETAILS</h3>
				<form id="f1" runat="server">
                
              
                    <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" CssClass="table table-hover table-responsive" OnItemCommand="DataList1_ItemCommand">
                        <ItemTemplate>
                            <table Class="table table-hover table-responsive">
                                <tr>
                                    <td>
                                        <asp:Image ID="Image1" runat="server" CssClass="img-circle" Height="98px" Width="120px" ImageUrl='<%# bind("photo") %>' />
                                        <br />
                                        <br />
                                        &nbsp;<table class="nav-justified">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Button ID="Button1" runat="server" CommandArgument='<%# bind("email") %>' Text="Button" CssClass="form-control" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
