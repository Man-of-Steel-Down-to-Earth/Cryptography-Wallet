<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_users.aspx.cs" Inherits="Admin_view_users" %>
	...
	<div class="main-content">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				<!--toggle button start-->
				<button id="Button2"><i class="fa fa-bars"></i></button>
				<!--toggle button end-->
				<!--logo -->
				<div class="logo">
					<a href="index.html">
				...
				<div class="search-box">
					<form class="input">
						<input class="sb-search-input input__field--madoka" placeholder="Search..." type="search" id="Search1" />
		...
		<div id="page-wrapper">
			<div class="main-page general">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox1" runat="server" />
                                <asp:Image ID="Image1" runat="server" Height="37px" ImageUrl='<%# bind("photo") %>' Width="43px" />
                                <br />
                                <asp:Label ID="Label1" runat="server" Text='<%# bind("uid") %>' Visible="False"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="fname" HeaderText="Name" />
                        <asp:BoundField DataField="username" HeaderText="Emailid" />
                        <asp:BoundField DataField="rdate" HeaderText="Registered Date" />
 <asp:TemplateField>
                            <ItemTemplate>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Click to Accept/Reject"  CssClass="btn btn-sm btn-success form-control" OnClick="Button1_Click"/>
				</form>
				</div>
		</div>
		<!--footer-->
