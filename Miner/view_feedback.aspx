<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_feedback.aspx.cs" Inherits="Admin_view_feedback" %>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page general">
				<h3 class="title1">VIVIEW FEEDBACK DETAILS</h3>
				<form id="f1" runat="server">
                
              
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption="Feedbacks" CaptionAlign="Left" CellPadding="90" CellSpacing="80" GridLines="None" ShowHeader="False" CssClass="table table-hover">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# bind("name") %>' ForeColor="Green"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
		...
		<!--footer-->
		<div class="footer">
		   <p>&copy; 2016 Novus Admin Panel. All Rights Reserved | Design by  href="https://w3layouts.com/" target="_blank">w3layouts</a></p>
		</div>
        <!--//footer-->
	</div>
	<!-- Classie -->
