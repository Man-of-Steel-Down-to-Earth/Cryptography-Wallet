<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fullduplication.aspx.cs" Inherits="user_fullduplication" %>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10">
                    <asp:DataList ID="DataList1" runat="server" class="table table-hover table-borderless" OnUpdateCommand="DataList1_UpdateCommand" OnDeleteCommand="DataList1_DeleteCommand">
                        <ItemTemplate>
