...
public partial class user_fullduplication : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ds = db.discont("select fname+lname as name,upload_date,upload_by from [tb_upload],[tb_user_registration] where [tb_user_registration].username=tb_upload.upload_by and [duplicated_st]='" + "1" + "' and duplicated_parts='" + check + "' ");
    ...
    protected void DataList1_DeleteCommand(object source, DataListCommandEventArgs e)
    {
        ...
        db.extnon("insert into tb_duplication_complaints values('"+Session["user"]+"','"+to+"','"+DateTime.Now.ToString()+"','"+complaints+"','"+"1"+"')");
